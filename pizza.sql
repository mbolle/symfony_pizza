...
(1, 'Pizza Vlees', 'images/PizzaVlees.jpg'),
(2, 'Pizza Vis', 'images/Pizzavis.jpg'),
(3, 'Pizza Veggi', 'images/VeggiPizza.jpg');
...
INSERT INTO `pizza` (`id`, `pizza_id`, `name`, `image`) VALUES
(1, 1, 'Pizza Salami', 'images/SalamiPizza.jpeg'),
...
ALTER TABLE `pizza`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IDX_CFDD826FD41D1D42` (`pizza_id`);
